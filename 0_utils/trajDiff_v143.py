...
class Milo2:
    ...
    def make_pseudobulk_parallel(self,
        ...
        results = joblib.Parallel(n_jobs=njob)(joblib.delayed(process_iteration)(i) for i in tqdm(range(nhoods.shape[1])))
    ...
    def da_expression(
        ...
        results = joblib.Parallel(n_jobs=njob)(joblib.delayed(da)(i) for i in tqdm(range(nhoods.shape[1])))
        res_df = pd.DataFrame()
    ...
    def make_whole_cpm(
        ...
        print("Using edgeR to find CPM......")
        #results = joblib.Parallel(n_jobs=njob)(joblib.delayed(da)(i) for i in tqdm(range(10)))
        results = joblib.Parallel(n_jobs=n_jobs)(joblib.delayed(da)(i) for i in tqdm(range(len(indexCell))))
