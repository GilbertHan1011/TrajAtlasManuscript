...
import HCLA_utils # self-built module in same folder as this module
...
def get_correlation_or_mi(cov1, cov2, obs_df, verbose=True):
    ...
    cov1_nans = np.vectorize(HCLA_utils.check_if_nan)(cov1_unfiltered)
    ...
    cov2_nans = np.vectorize(HCLA_utils.check_if_nan)(cov2_unfiltered)
