...
saveRDS(mrtree_res,"result/4.26_annotation//4.26_mrtree_res_raw.rds")
...
cluster_object = list(labelmat = labelmat,
                      ...
                      data_tree = tree.datatree,
                      mrtree_output = mrtree_res)
saveRDS(cluster_object,"result/4.26_annotation//4.26_cluster_object.Rds")
